...
def main():
    ...
    if args.keyword:
        ...
        rss_url = f"https://www.bing.com/news/search?q={args.keyword}&format=rss"
        ...
        if feed.entries:
            ...
            for e in feed.entries[: args.limit]:
                ...
                from utils.notion_client import add_to_notion
